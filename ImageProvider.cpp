...
ImageProvider::ImageProvider(Window *w, QString dir) : wnd(w) {
    io = new PIO(this);
    ...
    connect(this, &ImageProvider::titleChanged, wnd, &Window::titleChanged, Qt::QueuedConnection);

    QFile f("/home/ilya/.myQtProgs/photos_last.json");
...
void ImageProvider::setOriginalScale(float f) {
    wnd->original_scale = f;
}
